      ...
      <section className="relative pt-52 pb-28 px-8 overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap justify-center gap-4 w-full max-w-md sm:max-w-none mx-auto">
            <Link to="/diagnostico" className="flex items-center justify-center gap-2 bg-white text-[#0A1A3A] px-8 py-3 rounded-lg font-semibold text-sm hover:bg-slate-100 transition"><Icon name="sports_soccer" className="text-lg" />Soy Jugador</Link>
